...
def Wish():
    ...
    if hour >= 0 and hour < 12:
        speak("Good Morning Sir", voice="Linda", emotion="happy")
    elif hour >= 12 and hour < 18:
        speak("Good Afternoon Sir", voice="Linda", emotion="neutral")
    else:
        speak("Good Evening Sir", voice="Linda", emotion="neutral")
    
    speak("How can I help you today?", voice="Linda", emotion="neutral")
